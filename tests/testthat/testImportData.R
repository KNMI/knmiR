...
test_that("Station id output", {
  ...
  expect_equal_to_reference(HomogenPrecip(17, "1951/1955", path = NULL)[1 : 10,], file = "./referenceOutput/outputDenBurg.rds")
  expect_equal_to_reference(HomogenPrecip(10, "1910/1920", path = NULL)[1 : 10,], file = "./referenceOutput/outputHollum.rds")
})
...
test_that("Area output", {
  ...
  expect_warning(HomogenPrecip(ValleiEnVeluwe, "1945/1962", 1951, path = NULL), "Period is restricted to 1951-01-01/1962-12-31")
  expect_message(HomogenPrecip(ValleiEnVeluwe, "1955/1962", 1910, path = NULL), "You could consider more stations for the given period.")
  ...
  expect_equal_to_reference(HomogenPrecip(ValleiEnVeluweTransformed, "1911/1912", path = NULL)[1 : 10, ], "./referenceOutput/HomogenPrecipValleiEnVeluwe.rds")
})
